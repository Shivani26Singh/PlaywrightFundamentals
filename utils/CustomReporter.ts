 ...
 * @description Self-contained HTML reporter with real-time updates, step tracking, screenshots, videos & traces
 */
...
<body>
    <div class="header"><h1>📊 Report History</h1><p>Playwright Automation Framework</p></div>
...
<body>
    <div class="header">
        ...
        <p class="header-subtitle">Playwright Automation Framework</p>
    </div>
    ...
    <footer class="report-footer">
        <p>Custom HTML Reporter by Shivani Singh</p>
    </footer>
    ...
    private generateTestTable(): string {
        ...
        for (const test of this.testResults) {
            ...
            const author = process.env.TEST_AUTHOR || 'Shivani Singh';
